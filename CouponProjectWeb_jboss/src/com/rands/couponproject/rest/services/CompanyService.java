...
import com.rands.couponproject.ejb.client.IncomeMDBClient;
...
//	}
	...
	public void createCoupon(Coupon coupon) throws Exception {
		...
		try {
			...
			IncomeMDBClient MDBClient = new IncomeMDBClient();
			MDBClient.produceIncome(getCurrentCompany().getCompanyName(), 100, IncomeType.COMPANY_CREATE_COUPON);
	...
	public void updateCoupon(Coupon coupon) throws Exception {
		...
		try {
			...
			IncomeMDBClient MDBClient = new IncomeMDBClient();
			MDBClient.produceIncome(getCurrentCompany().getCompanyName(), 10, IncomeType.COMPANT_UPDATE_COUPON);
